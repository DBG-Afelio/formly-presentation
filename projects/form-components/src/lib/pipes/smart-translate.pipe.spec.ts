...
describe('Pipe: SmartTranslate', () => {
    ...
    it ('should translate one key with other text', () => {
        ...
        expect(smartTranslatePipe.transform('test TEST.LABELtest')).toBe('test Label Test', '3');
        expect(smartTranslatePipe.transform('testTEST.LABELtest')).toBe('testLabel Test', '4');
    ...
    it('should translate multiple keys', () => {
        ...
        expect(smartTranslatePipe.transform('test TEST.LABELtest TEST.LABEL_TWO.HELLOtest')).toBe('test Label Test Coucoutest', '3');
        expect(smartTranslatePipe.transform('testTEST.LABELtest TEST.LABEL_TWO.HELLO')).toBe('testLabel Test Coucou', '4');
